...
class ProductTemplate(models.Model):
    ...
    service_tracking = fields.Selection([
        ...
        ('gio_fieldservice_task', 'Create a new fieldservice project and task')
    ...
    def _check_project_and_template(self):
        ...
        for product in self:
            ...
            elif product.service_tracking == 'gio_fieldservice_task' and product.project_id:
                raise ValidationError(_('The product %s should not have a global project since it will generate a project.') % (product.name,))
    ...
    def _onchange_service_tracking(self):
        if self.service_tracking == 'no':
            ...
            self.project_id = False
        elif self.service_tracking == 'gio_fieldservice_task':
            self.project_id = False
